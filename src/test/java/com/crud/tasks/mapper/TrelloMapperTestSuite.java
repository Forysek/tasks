...
public class TrelloMapperTestSuite {
    ...
    public void mapToBoardsTest() {
        ...
        TrelloBoardDto boardDto1 = new TrelloBoardDto("1", "Test Board 1", emptyList);
        TrelloBoardDto boardDto2 = new TrelloBoardDto("2", "Test Board 2", listDtos);
    ...
    public void mapToBoardsDtoTest() {
        ...
        TrelloBoard boardDto1 = new TrelloBoard("1", "Test Board 1", emptyList);
        TrelloBoard boardDto2 = new TrelloBoard("2", "Test Board 2", listDtos);
